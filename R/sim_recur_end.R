...
#'   \item{recurrence_end}{dbl \emph{Unobservable} end-time of the recurrent event process}
#'   \item{C}{dbl Censoring time}
#'   \item{xi}{dbl \emph{Unobservable} subject-specific frailty of the
...
sim_recur_end <- function(
  ...
  if (!is.null(cov_fun)) {
    ...
    if (ncol(Z) != length(beta)) {
      stop(
        "The covariate matrix generated by 'cov_fun' should have number of columns
